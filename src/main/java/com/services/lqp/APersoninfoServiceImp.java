...
public class APersoninfoServiceImp implements  APersoninfoService {
    ...
    @Override
    public int insertinfoAdd(TbPersoninfo tbPersoninfo) {
        return aPersoninfo.insertinfoAdd(tbPersoninfo);
    }
    ...
    @Override
    public int updatehire(TbPersoninfo tbPersoninfo) {
        return aPersoninfo.updatehire(tbPersoninfo);
    }
}
