...
public class ANeedImp implements ANeedService {
    ...
    private ANeed need;
    @Override
    public List<Map> findneedall(@Param("tbRecruitmentneed") TbRecruitmentneed tbRecruitmentneed, TbDeparment tbDeparment, @Param("small") String small, @Param("big") String big ) {
    ...
    @Override
    public int updateneedshenpi(TbRecruitmentneed tbRecruitmentneed) {
        return need.updateneedshenpi(tbRecruitmentneed);
    }
