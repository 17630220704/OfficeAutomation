...
public class AHireController {
    ...
    public List<Map> selectplan(TbRecruitmentplan tbRecruitmentplan){
        Map<String,Object> map = new HashMap<String,Object>();
        List<Map> list =ahireImp.findplanthem(tbRecruitmentplan);
        return list;
    }
    /*@ResponseBody
    ...
    public String insertHire(TbHirefile tbHirefile){
        System.out.println("AHire：进入添加方法"+tbHirefile);
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    @ResponseBody
    @RequestMapping(value="/insertHireAdd")
    public String insertHireAdd(TbHirefile tbHirefile){
        System.out.println("AHire：进入添加方法"+tbHirefile);
        Map<String, Object> map = new HashMap<String, Object>();
        int a = ahireImp.inserthireAdd(tbHirefile);
        System.out.println("影响行数"+a);
        System.out.println(map);
        map.put("a", a);
        return "redirect:/ahire/selectAll";
    ...
    @ResponseBody
    @RequestMapping(value="/updateHireAdd")
    public String updateHireAdd(TbHirefile tbHirefile){
        Map<String,Object> map = new HashMap<String, Object>();
        ahireImp.updatehireAdd(tbHirefile);
        System.out.println(tbHirefile);
        return "redirect:/ahire/selectAll";
    }
}
