...
public class APlanController {
    ...
    public Map<String,Object> selectSX(){
        Map<String,Object> map = new HashMap<String, Object>();
        List<Map> list = aplanImp.findplanSX();
        map.put("list", list);
        return map;
    }
    @ResponseBody
    ...
    @ResponseBody
    @RequestMapping(value="/selectPlanEnd")
    public List<Map<String,Object>> select2End(){
        Map<String,Object> map = new HashMap<String,Object>();
        List<Map<String,Object>> list =aplanImp.findplanbynameEnd();
        return list;
    }
    @ResponseBody
    @RequestMapping(value="/selecthirePlan")
    public List<Map<String,Object>> selecthirePlan(){
        Map<String,Object> map = new HashMap<String,Object>();
        List<Map<String,Object>> list =aplanImp.findplanbypeople();
        return list;
    }
    @ResponseBody
    ...
    public String insertPlan(TbRecruitmentplan tbRecruitmentplan){
        ...
        System.out.println(tbRecruitmentplan.getPlanId());
       /* if (a>0){
            aplanImp.updatehire(tbHirefile);
            System.out.println("plan添加返回hire数据"+tbHirefile.getRemark());
        }*/
    ...
    @ResponseBody
    @RequestMapping(value="/insertPlanAdd")
    public String insertPlanAdd(TbRecruitmentplan tbRecruitmentplan){
        Map<String, Object> map = new HashMap<String, Object>();
        int a = aplanImp.insertplanAdd(tbRecruitmentplan);
        System.out.println("影响行数"+a);
        System.out.println(map);
        map.put("a", a);
        return "redirect:/selectAll";
    ...
    public String updatepeople1(TbRecruitmentplan tbRecruitmentplan,TbHirefile tbHirefile){
        Map<String,Object> map = new HashMap<String, Object>();
      int a=  aplanImp.updatepeople1(tbRecruitmentplan);
        System.out.println(tbRecruitmentplan.getPlanId());
        if (a>0){

            aplanImp.updatehire(tbRecruitmentplan);
        }
        System.out.println(tbRecruitmentplan);
        return "redirect:/Plan/selectAll";
    }
    @ResponseBody
    @RequestMapping(value="/updatepeopleAdd")
    public String updatepeopleAdd(TbRecruitmentplan tbRecruitmentplan){
        Map<String,Object> map = new HashMap<String, Object>();
        aplanImp.updateplanAdd(tbRecruitmentplan);
        System.out.println(tbRecruitmentplan);
        return "redirect:/Plan/selectAll";
    }
}
