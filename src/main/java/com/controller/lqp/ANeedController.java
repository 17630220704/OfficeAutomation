...
public class ANeedController {
    ...
    public Map<String,Object> select(TbRecruitmentneed tbRecruitmentneed, TbDeparment tbDeparment, @RequestParam(value="small",required=false) String small, @RequestParam(value="big",required=false) String big){
        Map<String,Object> map = new HashMap<String, Object>();
        List<Map> list = aneedImp.findneedall(tbRecruitmentneed,tbDeparment,small, big);
        System.out.println(list);
        System.out.println("时间小"+small);
        System.out.println("时间大"+big);
        map.put("list", list);
        return map;
    }
    @ResponseBody
    ...
    @ResponseBody
    @RequestMapping(value="/updateNeedshenpi")
    public String updateNeedshenpi(TbRecruitmentneed tbRecruitmentneed){
        Map<String,Object> map = new HashMap<String, Object>();
        aneedImp.updateneedshenpi(tbRecruitmentneed);
        System.out.println(tbRecruitmentneed);
        return "redirect:/selectAll";
    }
}
