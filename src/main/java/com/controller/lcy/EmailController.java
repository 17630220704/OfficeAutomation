...
public class EmailController {
    ...
    public Map mailAdd(HttpServletResponse response, Mailboxinfo2 mailboxinfo2) {
        ...
        for (int i = 0; i < sourceStrArray.length; i++) {
            ...
            e.setPosiId(Integer.valueOf(sourceStrArray[i]));
            e.setReadFlag(0);
            e.setDeleteFlag(0);
            e.setReceipt(0);
            e.setIsF(0);
    ...
    public ModelAndView CGQueryt(HttpServletResponse response, int bodyId) {
        ...
        ModelAndView mod = new ModelAndView("/email/caEmail1");
    ...
    public Map<String, Object> methodx(HttpServletRequest session,
    ...
    @RequestMapping(value = "/Tbuserpass")
    @ResponseBody
    public List<Map> Tbuserpass(HttpServletResponse response, int uId) {
        response.setContentType("html/text;charset=utf-8");
        response.setCharacterEncoding("utf-8");
        List<Map> user = mail.Tbuserpass(uId);
