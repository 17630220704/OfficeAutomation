                ...
                <div class="modal-body">
                    ...
                    <table cellspacing="0"cellpadding="0" border="1xp solid #9c9c9c;">
                        <tr>
                            <td class="td1">职位：</td>
                            <td class="td2">
                                <select id="select" name="posiId" >

                                </select></td>
                            <td class="td1">名称：</td>
                            <td class="td2"><input type="text" class="form-control" name="personName" placeholder="请输入合同编号"></td>
                        </tr>
                        <tr>
                            <td class="td1">生日：</td>
                            <td class="td2"><input type="date" class="form-control" name="personBirth" placeholder="请输入合同编号"></td>
                            <td class="td1">头像：</td>
                            <td class="td2"><input type="text" class="form-control" name="personPicture" placeholder="请输入合同编号"></td>
                        </tr>
                        <tr>
                            <td class="td1">手机号：</td>
                            <td class="td2"><input type="text" class="form-control" name="telephone" placeholder="请输入合同编号"></td>
                            <td class="td1">办公电话：</td>
                            <td class="td2"><input type="text" class="form-control" name="officePhone" placeholder="请输入合同编号"></td>
                        </tr>
                        <tr>
                            <td class="td1">邮箱：</td>
                            <td class="td2"><input type="text" class="form-control" name="email" placeholder="请输入合同编号"></td>
                            <td class="td1">现住址：</td>
                            <td class="td2"><input type="text" class="form-control" name="nowAddress" placeholder="请输入合同编号"></td>
                        </tr>
                        <tr>
                            <td class="td1">备注：</td>
                            <td class="td2"><input type="text" class="form-control" name="remark" placeholder="请输入合同编号"></td>
                            <td class="td1">现公司状态：</td>
                            <td class="td2"><input type="text" class="form-control" name="nowState" placeholder="请输入合同编号"></td>
                        </tr>
                    </table>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table cellspacing="0"cellpadding="0" border="1xp solid #9c9c9c;">
                        ...
                        <tr>
                            <td class="td1">头像：</td>
                            <td class="td2"><input type="text" class="form-control xg4" name="personPicture" placeholder="请选择雇员"></td>
                            <td class="td1">手机号：</td>
                            <td class="td2"><input type="text" class="form-control xg5" name="telephone" placeholder="请选择雇员"></td>
                        </tr>
                        <tr>
                            <td class="td1">办公电话：</td>
                            <td class="td2"><input type="text" class="form-control xg6" name="officePhone" placeholder="请输入公司名"></td>
                            <td class="td1">邮箱：</td>
                            <td class="td2"><input type="text" class="form-control xg7" name="email" placeholder="合同类型"></td>
                        </tr>
                        <tr>
                            <td class="td1">现住址：</td>
                            <td class="td2"><input type="text" class="form-control xg8" name="nowAddress" placeholder="请选择雇员"></td>
                            <td class="td1">备注：</td>
                            <td class="td2"><input type="text" class="form-control xg9" name="remark" placeholder="请选择雇员"></td>
                        </tr>
                        <tr>
                            <td class="td1">现公司状态：</td>
                            <td class="td2"><input type="text" class="form-control xg10" name="nowState" placeholder="请输入公司名"></td>
                            <%-- <td class="td1">现公司状态：</td>
            ...
            success:function(data){
                ...
                for (i = 0; i < data.list.length ; i++) {
                    a+="<tr ><td>"+data.list[i].persoId
                        ...
                        +"</td><td>"+data.list[i].personPicture
