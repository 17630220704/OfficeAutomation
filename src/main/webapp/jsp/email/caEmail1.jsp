        ...
        <table border="1px" style="width: 100%">
            <tr>
                ...
                <td style="width: 85%">
                    ...
                    <input type="text" class="form-control" style="width: 70%; Float:left" id="persoId" disabled="disabled"
                           value="${map[0].persoId}">
                </td>
            <tr>
                ...
                <td style="width: 85%">
                    <input type="text" class="form-control" style="width: 70%; Float:left;display: none" id="toId1"
                           value="${map[0].TO_ID2}">
                    <input type="text" class="form-control" style="width: 70%; Float:left" id="toId2" disabled="disabled"
