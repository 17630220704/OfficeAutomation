...
<head>
    ...
    <script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath}/resources/js_lcy/ckeditor/config.js"></script>
    <%--Bootstrap 实例 - 面板标题--%>
    <link rel="stylesheet" href="https://cdn.staticfile.org/twitter-bootstrap/3.3.7/css/bootstrap.min.css">
    <script src="https://cdn.staticfile.org/jquery/2.1.1/jquery.min.js"></script>
    <script src="https://cdn.staticfile.org/twitter-bootstrap/3.3.7/js/bootstrap.min.js"></script>
    ...
    <div class="panel-body">
        <table border="1px" style="width: 100%">
            <tr>
                ...
                <td style="width: 85%">
                    <input type="text" class="form-control" style="width: 70%; Float:left;display: none" id="persoId"
                           readonly="readonly" value="${userid}">
                    <input type="text" class="form-control" style="width: 70%; Float:left" id="persoId1"
