            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table cellspacing="0"cellpadding="0" border="1xp solid #9c9c9c;">
                        ...
                        <td class="td1">招聘计划：</td>
                            <td class="td2"><select id="selectplan1" class="form-control" name="planId" ></select></td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table cellspacing="0"cellpadding="0" border="1xp solid #9c9c9c;">
                        <tr>
                            <td class="td1">编号：</td>
                            <td class="td2"><input type="text" class="form-control xg0" disabled="disabled" name="empId" placeholder="请输入公司名"></td>
                            <td class="td1">姓名：</td>
                            <td class="td2"><input type="text" class="form-control xg1" name="empName" placeholder="合同类型"></td>
                        </tr>
                        <tr><td class="td1">招聘计划：</td>
                            <td class="td2"><select id="selectplan" class="form-control" name="planId" ></select></td>
                        </tr>
                        <tr>
                            <td class="td1">性别：</td>
                            <td class="td2"><input type="text" class="form-control xg6" name="enpSex" placeholder="请输入公司名"></td>
                            <td class="td1">出生日期：</td>
                            <td class="td2"><input type="date" class="form-control xg7" name="birthTime" placeholder="合同类型"></td>
                        </tr>
                        <tr>
                            <td class="td1">籍贯：</td>
                            <td class="td2"><input type="text" class="form-control xg8" name="homePlase" placeholder="请输入公司名"></td>
                            <td class="td1">名族：</td>
                            <td class="td2"><input type="text" class="form-control xg9" name="nation" placeholder="合同类型"></td>
                        </tr>
                        <tr>
                            <td class="td1">政治面貌：</td>
                            <td class="td2"><input type="text" class="form-control xg10" name="politics" placeholder="请输入公司名"></td>
                            <td class="td1">身份证：</td>
                            <td class="td2"><input type="text" class="form-control xg11" name="nodyId" placeholder="合同类型"></td>
                        </tr>
                        <tr>
                            <td class="td1">手机号：</td>
                            <td class="td2"><input type="text" class="form-control xg12" name="telephone" placeholder="请输入公司名"></td>
                            <td class="td1">毕业学校：</td>
                            <td class="td2"><input type="text" class="form-control xg13" name="graduateSchool" placeholder="合同类型"></td>
                        </tr>
                        <tr>
                            <td class="td1">专业：</td>
                            <td class="td2"><input type="text" class="form-control xg14" name="speciality" placeholder="请输入公司名"></td>
                            <td class="td1">学历：</td>
                            <td class="td2"><input type="text" class="form-control xg15" name="scientificName" placeholder="合同类型"></td>
                        </tr>
                        <tr>
                            <td class="td1">毕业日期：</td>
                            <td class="td2"><input type="date" class="form-control xg16" name="graduateTime" placeholder="请输入公司名"></td>
                            <td class="td1">家庭住址：</td>
                            <td class="td2"><input type="text" class="form-control xg17" name="homeAddress" placeholder="合同类型"></td>
                        </tr>
                        <tr>
                            <td class="td1">邮编：</td>
                            <td class="td2"><input type="text" class="form-control xg18" name="post" placeholder="请输入公司名"></td>
                            <td class="td1">应聘岗位：</td>
                            <td class="td2"><input type="text" class="form-control xg19" name="ministration" placeholder="合同类型"></td>
                        </tr>
                        <tr>
                            <td class="td1">期待从事行业：</td>
                            <td class="td2"><input type="text" class="form-control xg20" name="expectedIndustry" placeholder="请输入公司名"></td>
                            <td class="td1">期待从事职业：</td>
                            <td class="td2"><input type="text" class="form-control xg21" name="expectedOccupation" placeholder="合同类型"></td>
                        </tr>
                        <tr>
                            <td class="td1">期待工作城市：</td>
                            <td class="td2"><input type="text" class="form-control xg22" name="expectedCity" placeholder="请输入公司名"></td>
                            <td class="td1">期待薪资：</td>
                            <td class="td2"><input type="text" class="form-control xg23" name="expectedSalary" placeholder="合同类型"></td>
                        </tr>
                        <tr>
                            <td class="td1">到岗时间：</td>
                            <td class="td2"><input type="date" class="form-control xg24" name="workTime" placeholder="请输入公司名"></td>
                            <td class="td1">招聘渠道：</td>
                            <td class="td2"><input type="text" class="form-control xg25" name="recruitment" placeholder="合同类型"></td>
                        </tr>
                        <tr>
                            <td class="td1">特长：</td>
                            <td class="td2"><input type="text" class="form-control xg26" name="specialty" placeholder="请输入公司名"></td>
                            <td class="td1">职业技能：</td>
                            <td class="td2"><input type="text" class="form-control xg27" name="skill" placeholder="合同类型"></td>
                        </tr>
                        <tr>
                            <td class="td1">职业经验：</td>
                            <td class="td2"><input type="text" class="form-control xg28" name="projectExperience" placeholder="请输入公司名"></td>
                            <td class="td1">工作经验：</td>
                            <td class="td2"><input type="text" class="form-control xg29" name="workExperience" placeholder="合同类型"></td>
                        </tr>
                        <tr>
                            <td class="td1">备注：</td>
                            <td class="td2"><input type="text" class="form-control xg30" name="remark" placeholder="请输入公司名"></td>
                            <td class="td1">录入人：</td>
                            <td class="td2"><input type="text" class="form-control xg31" name="hireName" placeholder="合同类型"></td>
                        </tr>
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                for(i=0;i<data.length;i++){
                    a+="<option value='"+data[i].PlanID+"'>"+data[i].planName+"</option>"
                }
                $("#selectplan").append(a);
                $("#selectplan1").append(a);
            }
        })
    });
