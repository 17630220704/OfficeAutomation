            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table cellspacing="0"cellpadding="0" border="1xp solid #9c9c9c;">
                        <tr>
                            <td class="td1">人才：</td>
                            <td class="td2"><select  id="select" class="form-control" name="empId" ></select></td>
                            <td class="td1">计划名称：</td>
                            <td class="td2"><input type="text" class="form-control" name="planName" placeholder="请输入合同编号"></td>
                        </tr>
                        <tr>
                            <td class="td1">招聘渠道：</td>
                            <td class="td2">
                        ...
                        <tr>
                            <td class="td1">结束时间：</td>
                            <td class="td2"><input type="date" class="form-control" name="endTime" placeholder="请输入合同编号"></td>
                            <td class="td1">预算费用：</td>
                            <td class="td2"><input type="text" class="form-control" name="budget" placeholder="请输入合同编号"></td>
                        </tr>
                        <tr>
                            <td class="td1">招聘说明：</td>
                        ...
                        <tr>
                            <td class="td1">招聘人及备注：</td>
                            <td class="td2" colspan="3">
                                <textarea class="form-control" name="planNote" id="myuser2" rows="3"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td class="td1">备注提醒：</td>

                            <td class="td2" colspan="3">
                                <textarea class="form-control" name="noteRemind"  rows="3"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td class="td1">审批状态：</td>
                ...
                <div class="modal-body">
                    ...
                    <table cellspacing="0"cellpadding="0" border="1xp solid #9c9c9c;">
                        <tr>
                            ...
                            <td class="td1">人才：</td>
                            <td class="td2"><select id="select1" name="empId" ></select></td>
                        </tr>
                        <tr>
                            <td class="td1">计划名称：</td>
                            <td class="td2"><input type="text" class="form-control xg2" name="planName" placeholder="请输入公司名"></td>
                            <td class="td1">招聘渠道：</td>
                            <td class="td2"><input type="text" class="form-control xg3" name="dictionaryId" placeholder="合同类型"></td>
                        </tr>
                        <tr>
                            <td class="td1">开始时间：</td>
                            <td class="td2"><input type="text" class="form-control xg4" name="startTime" placeholder="请输入公司名"></td>
                            <td class="td1">结束时间：</td>
                            <td class="td2"><input type="text" class="form-control xg5" name="endTime" placeholder="合同类型"></td>
                        </tr>
                        <tr>
                            <td class="td1">预算费用：</td>
                            <td class="td2"><input type="text" class="form-control xg6" name="budget" placeholder="请输入公司名"></td>
                            <td class="td1">招聘说明：</td>
                            <td class="td2"><input type="text" class="form-control xg7" name="planInstructions" placeholder="合同类型"></td>
                        </tr>
                        <tr>
                            <td class="td1">招聘备注：</td>
                            <td class="td2"><input type="text" class="form-control xg8" name="planNote" placeholder="请输入公司名"></td>
                            <td class="td1">招聘提醒：</td>
                            <td class="td2"><input type="text" class="form-control xg9" name="noteRemind" placeholder="合同类型"></td>
                        </tr>
                        <tr>
                            <td class="td1">审批状态：</td>
                            <td class="td2"><input type="text" class="form-control xg10" name="approvalStatus" placeholder="请输入公司名"></td>
                        </tr>
