    ...
    <form id="tj_tpquery">
        <table cellspacing="0"cellpadding="0" style="margin:0 auto;">
            <tr>
                ...
                <td class="td2" ><input type="text" class="form-control tbPersoninfoQuery planName" id="planName" name="planName" placeholder="请输入计划名称"></td>
                <td class="td1">计划审批状态：</td>
                <td class="td2" >
                <select class="form-control approvalStatus" id="approvalStatus" name="approvalStatus">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table cellspacing="0"cellpadding="0" border="1xp solid #9c9c9c;">
                        <tr>
                            <td class="td1">编号：</td>
                            <td class="td2"><input type="text" class="form-control xg0" id="planId" disabled="disabled" placeholder="请选择雇员"></td>
                           <%-- <td class="td1">计划名称：</td>
                        ...
                        <tr>
                            ...
                            <td class="td2"><input type="text" class="form-control xg2"  placeholder="合同类型"></td>
                            --%><td class="td1">审批状态：</td>
                            <td class="td2">
                                <select class="form-control "  id="approvalStatus2">
                                    <option value="">---请选择---</option>
                                    <option value="1">通过</option>
                                    <option value="2">未审批</option>
                                    <option value="3">驳回</option>
...
/*
    ...
    function TSetaffUpdate(){
        ...
        $.ajax({
            ...
            data:{
                'planId':$("#planId").val(),
                'approvalStatus':$("#approvalStatus2").val()
            },
            dataType:"json"
        }).always(function(){
            TbPersoninfoQuery();
