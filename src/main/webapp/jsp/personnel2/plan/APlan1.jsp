            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table cellspacing="0"cellpadding="0" border="0xp solid #9c9c9c;">
                        <tr>
                            <td class="td1">编号：</td>
                            <td class="td2"><input type="text" class="form-control xg0" id="planIdinput" name="planId" disabled="disabled" placeholder="请选择雇员"></td>
                            </tr>
                        <tr>
                            <td class="td1">招聘备注：</td>
                            <td >
                                <div style="margin-left: 30%; width: 50%; float: left;">
                                    ...
                                    <div class="layui-form-item">
                                        <div class="layui-input-block">
                                            ...
                                            <input type="text" name="planNote" id="planNoteinput" lay-verify="required" readonly="readonly" autocomplete="off"  placeholder="人员"
