...
<legend><center>招聘计划待面试人员录入</center></legend>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table cellspacing="0"cellpadding="0" border="0xp solid #9c9c9c;">
                        <tr>
                            <td class="td1">编号：</td>
                            <td class="td2"><input type="text" class="form-control xg0" name="planId" id="planIdinput" disabled="disabled" placeholder="请选择雇员"></td>
                        </tr>
                        <tr>
                            <td class="td1">招聘备注：</td>
                            <td >
                                <div style="margin-left: 30%; width: 50%; float: left;">
                                    ...
                                    <div class="layui-form-item">
                                        <div class="layui-input-block">
                                            ...
                                            <input type="text" name="noteRemind" id="noteRemindinput" lay-verify="required" readonly="readonly" autocomplete="off"  placeholder="人员"
                                                   class="layui-input userId"    style="width:180px">
...
<div id="mtk3" style="display: none;" class="modal-content">
    <div class="modal-body">
        <div class="col-xs-2" >
            <select name="from1" id="from1" multiple="multiple" class="multiselect form-control" size="8" style="width:80px" style="height:150px">
...
<script>
            ...
            success:function(data){
                ...
                for (i = 0; i < data.list.length ; i++) {
                    a+="<tr ><td>"+data.list[i].PlanID//编号
                        ...
                        +"</td><td><button class='btn btn-primary xiugai' value='"+i+"' data-toggle='modal' data-target='#myModa3'>面试人员录入</buuton>"
                        +"</td></tr>"
                }
    ...
    function TSetaffUpdate(){
        $.ajax({
            ...
            type:"post",
            data:{
                'planId':$("#planIdinput").val(),
                'noteRemind':$("#noteRemindinput").val()
            },
            dataType:"json"
        }).always(function(){
            TdStaffQuery();
    ...
    $.ajax({
        ...
        success:function(data){
            $("#from1").html("");
            var a ="";
            for(lu=0;lu<data.list.length;lu++){
                a+="<option class='la' value='"+data.list[lu].PlanID+"'>"+data.list[lu].planName+"</option>"
            }
            $("#from1").append(a);
        }
    });
