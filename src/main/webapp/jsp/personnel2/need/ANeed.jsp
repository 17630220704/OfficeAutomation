...
<button class="btn btn-primary" data-toggle="modal" id="myuser1" data-target="#myModa2">新建需求录入</button>
                ...
                <div class="modal-body">
                    ...
                    <table cellspacing="0"cellpadding="0" border="1xp solid #9c9c9c;">
                        ...
                        <tr>
                            ...
                            <td class="td2">
<%--
                                <input type="text" class="form-control" id="myuser2" name="remark" placeholder="请输入公司名">
--%>
                    ...
                    <table cellspacing="0"cellpadding="0" border="1xp solid #9c9c9c;">
                        ...
                        <tr>
                            ...
                            <td class="td2" colspan="3">
                                ...
                                <textarea class="form-control xg5"  name="needRequirements"  rows="3"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td class="td1">提醒：</td>
                            ...
                            <textarea class="form-control xg6" name="remind"  rows="3"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td class="td1">备注：</td>
                            <td class="td2"><input type="text" class="form-control xg7" name="remark" disabled="disabled" placeholder="合同类型"></td>
                        </tr>
