    ...
    <form id="tj_tpquery">
        <table cellspacing="0"cellpadding="0" style="margin:0 auto;">
            <tr>
                ...
                <td class="td2" >
<%--
                    <input type="text" class="form-control TbPersoninfoQuery shaixuan" id="shaixuan" name="shaixuan" placeholder="请选择雇员">
--%>
                ...
                <div class="modal-body">
                    ...
                    <table cellspacing="0"cellpadding="0" border="1xp solid #9c9c9c;">
                        ...
                        <tr>
                            ...
                            <td class="td2">
<%--
                                <input type="text" class="form-control xg7" name="shaixuan" placeholder="请输入公司名">
--%>
                            ...
                            <td class="td1">备注：</td>
                            <td class="td2"><input type="text" class="form-control xg8" disabled="disabled" placeholder="请选择雇员"></td>
                            </tr>
                    </table>
                    </form>
                </div>
