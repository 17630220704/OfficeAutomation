...
<legend><center>招聘录用报表</center></legend>
<div id="body">
    <form id="tj_tpquery">
...
&lt;%&ndash;<form id="tj_tdquery"><input type="text" name="persoId"><button onclick="TdStaffQuery()">查询</button></form>&ndash;%&gt;
--%>
<%--查询合同--%>
<div id="tdquery"></div>
<%--新建合同--%>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table cellspacing="0"cellpadding="0" border="1xp solid #9c9c9c;">
                        <tr>
                            <td class="td1">计划名称：</td>
                            <td class="td2"><select id="select3" name="planId" >

                            </select></td>
                            <td class="td1">所属部门：</td>
                            <td class="td2"><select id="select" name="deptId" ></select></td>
                        </tr>
                        <tr>
                            <td class="td1">录用人：</td>
                            <td class="td2"><input type="text" class="form-control" name="headid" placeholder="请输入公司名"></td>
                            <td class="td1">录用日期：</td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table cellspacing="0"cellpadding="0" border="1xp solid #9c9c9c;">
                        <tr>
                            <td class="td1">id：</td>
                            <td class="td2"><input type="text" class="form-control xg0" name="employedId" placeholder="请输入公司名"></td>
                            <td class="td1">计划名称：</td>
                            <td class="td2"><select id="select4" name="planId" ></select></td>
                        </tr>
                        <tr>
                            <td class="td1">所属部门：</td>
                            <td class="td2"><select id="select2" name="deptId" ></select></td>
            ...
            success:function(data){
                ...
                for (i = 0; i < data.list.length ; i++) {
                    a+="<tr ><td>"+data.list[i].EmployedID
                        ...
                        +"</td><td>"+data.list[i].HireDate
                        +"</td><td>"+data.list[i].workEndTime
    ...
    $(function(){
        $.ajax({
            ...
            success:function(data){
                ...
                for(i=0;i<data.length;i++){
                    b+="<option value='"+data[i].planId+"'>"+data[i].planName+"</option>"
                }
                $("#select3").append(b);
                $("#select4").append(b);
            }
