            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table cellspacing="0"cellpadding="0" border="1xp solid #9c9c9c;">
                        <tr>
                            <td class="td1">id：</td>
                            <td class="td2"><input type="text" class="form-control xg0" name="employedId" disabled="disabled" placeholder="请选择雇员"></td>
                        ...
                        <tr>
                            ...
                            <td class="td1">备注：</td>
                            <td class="td2"><input type="text" class="form-control " name="remark" placeholder="请选择雇员"></td>
                        </tr>
                    </table>
...
<script>
            ...
            success:function(data){
                ...
                for (i = 0; i < data.length ; i++) {
                    a+="<tr ><td>"+data[i].EmployedID
                        ...
                        +"</td><td>"+data[i].remark
                        +"</td><td><button class='btn btn-primary xiugai' value='"+i+"' data-toggle='modal' data-target='#myModa3'>录用</buuton>"
                        +"</td></tr>"
                }
    ...
    function TSetaffUpdate(){
        ...
        $.ajax({
            url:"/employ/updatbyShaixuanluyong",
            type:"post",
