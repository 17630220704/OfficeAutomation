                ...
                <div class="modal-body">
                    <table cellspacing="0"cellpadding="0" border="1xp solid #9c9c9c;">
                        ...
                        <tr>
                            ...
                            <td class="td1">合同类型：</td>
                            <td class="td2">
                                <select class="form-control xg3" name="conTractType">
                                    <option value="固定合同">固定合同</option>
                                    <option value="临时合同">临时合同</option>
                                </select>
                            </td>
...
<script>
    ...
    $('body').on('click','.xiugai',function () {
         var xg3 = $(this).parent().parent().parent().children().eq((parseInt($(this).val())+1)).children().eq(3).html();
        for(i=0;i<17;i++){
        ...
        $(".xg3 option[value='"+xg3+"']").attr("selected","selected");
