...
<body>
<div>
    <button id="TpSalarySheetUpdate" class='btn btn-primary' onclick="TpSalarySheetUpdate()">上报</button>
</div>
<div id="a"></div>
<div>
...
<script>
    ...
    var arrh = arrhref[1].split("&state=");
    $(function(){
        if(arrh[1]==1){
            $("#TpSalarySheetUpdate").css("display","none");
        }
    });
    /*var persoId = 0;
    var id = 0;
